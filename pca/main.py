...
from src.plots import plot_biplot, plot_pc1_loadings, plot_pc1_scores, plot_scree
...
def main():
    ...
    _, X, countries = load_data(csv_path, config["country_column"], config["feature_columns"])
